...
def mking():
    ...
    if sultani in ('open', 'Open', 'OPEN'):
        ...
        mking()
    try:
        nama = requests.get('https://graph.facebook.com/me?access_token=%s' % sawx404).json()['name']
